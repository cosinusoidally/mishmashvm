...
f1={};
f1.fntype = ctypes.FunctionType(ctypes.default_abi,ctypes.uint32_t,[]);
f1.fn=ctypes.cast(ctypes.voidptr_t(ex2["ljw_setup"].address),f1.fntype.ptr);
setup=f1.fn;
...
//ar=["tcc", "-nostdinc", "-nostdlib","-c", "c_src/buffer.c","-I","c_src/:includes/usr/include/i386-linux-gnu/:includes/tmp/tcc/lib/tcc/include/"];
...
//ar=["tcc","-I","tcc-0.9.27/:includes/usr/include:includes/usr/include/i386-linux-gnu/:includes/tmp/tcc/lib/tcc/include/", "-c", "my_libc.c","-o","foo.o"];
