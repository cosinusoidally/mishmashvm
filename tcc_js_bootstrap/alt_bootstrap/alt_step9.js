...
*/
  ...
  var SETBE_rm8=function(){
    ...
    decode_modrm();
    if(dbg){
      print("SETBE_rm8_"+mode);
    };
    decoded=true;
    if(run){
      var d=new_icache_entry();
      d.rm8_dest=rm8_dest;
      d.insn=SETBE_rm8_exec;
      d.ilen=ilen;
      set_icache_entry(eip,d);
      ran=try_icache(eip);
      return;
  ...
  var SETB_rm8=function(){
    // 0F 92 SETB r/m8 Set byte if below (CF=1)
    ilen=2;
    decode_modrm();
    if(dbg){
      print("SETB_rm8_"+mode);
    };
    decoded=true;
    if(run){
      var d=new_icache_entry();
      d.rm8_dest=rm8_dest;
      d.insn=SETB_rm8_exec;
      d.ilen=ilen;
      set_icache_entry(eip,d);
      ran=try_icache(eip);
      return;
  ...
  var SETE_rm8=function(){
    ...
    decode_modrm();
    if(dbg){
      print("SETE_rm8_"+mode);
    };
    decoded=true;
    if(run){
      var d=new_icache_entry();
      d.rm8_dest=rm8_dest;
      d.insn=SETE_rm8_exec;
      d.ilen=ilen;
      set_icache_entry(eip,d);
      ran=try_icache(eip);
      return;
  ...
  var SETG_rm8=function(){
    ilen=2;
    decode_modrm();
    if(dbg){
      print("SETG_rm8_"+mode);
    };
    decoded=true;
    if(run){
      var d=new_icache_entry();
      d.rm8_dest=rm8_dest;
      d.insn=SETG_rm8_exec;
      d.ilen=ilen;
      set_icache_entry(eip,d);
      ran=try_icache(eip);
      return;
  ...
  var SETLE_rm8=function(){
    ilen=2;
    decode_modrm();
    if(dbg){
      print("SETLE_rm8_"+mode);
    };
    decoded=true;
    if(run){
      var d=new_icache_entry();
      d.rm8_dest=rm8_dest;
      d.insn=SETLE_rm8_exec;
      d.ilen=ilen;
      set_icache_entry(eip,d);
      ran=try_icache(eip);
      return;
  ...
  var SETNE_rm8=function(){
    ilen=2;
    decode_modrm();
    if(dbg){
      print("SETNE_rm8_"+mode);
    };
    decoded=true;
    if(run){
      var d=new_icache_entry();
      d.rm8_dest=rm8_dest;
      d.insn=SETNE_rm8_exec;
      d.ilen=ilen;
      set_icache_entry(eip,d);
      ran=try_icache(eip);
      return;
