...
["vsnprintf","vsnprintf"],
["ljw_crash_sigaction","sigaction"],["ljw_crash_sigemptyset","sigemptyset"],["ljw_crash_strcat","strcat"],["strchr","strchr"],["strcmp","strcmp"],["strcpy","strcpy"],["strlen","strlen"],["strncmp","strncmp"],["strrchr","strrchr"],["ljw_crash_strstr","strstr"],["strtod","strtod"],
["strtof","strtof"],
["strtol","strtol"],["ljw_crash_strtold","strtold"],["ljw_crash_strtoll","strtoll"],["ljw_crash_strtoul","strtoul"],
["strtoull","strtoull"],
...
tcc=f1.fn;
function compile(ar,options){
var std_flags="tcc -nostdinc -nostdlib -I ./includes/usr/include/:./includes/usr/include/i386-linux-gnu/:./includes/tmp/tcc/lib/tcc/include/:./includes/usr/include/SDL -c ";
...
if(options.no_std_flags){
print(ar);
} else {
ar=std_flags+extra_flags+ar;
};
} else {
ar=std_flags+ar;
};
